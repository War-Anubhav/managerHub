...
const MemberReport = () => {
    ...
    const [year, setYear] = useState(current.getFullYear().toString());
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl shadow-lg space-y-8">
            {/* Header Section */}
