                        ...
                        <div className="flex items-center">
                            ...
                            <nav className="ml-10 flex space-x-8">
                                ...
                                <Link to="/manager/project-summary"
                                      className="text-blue-600 border-b-2 border-blue-600 px-3 py-2 text-sm font-medium">Project
                                    Summary</Link>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                    ...
                    <div className="flex justify-between items-center mb-6 bg-blue-50 p-4 rounded-lg">
                        ...
                        <div className="relative" id="calendar-dropdown">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-blue-600"
                            ...
                            {showCalendar && (
                                <div
                                    className="absolute z-10 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 p-4 w-72">
                                    {/* Year Selection */}
                                    <div className="mb-4">
                    ...
                    <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-lg mb-6">
                        <div className="flex">
                            <div className="flex-shrink-0">
                                <svg className="h-6 w-6 text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none"
